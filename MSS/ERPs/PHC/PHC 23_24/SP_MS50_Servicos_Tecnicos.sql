	...
	OPEN curCabBo
		...
		WHILE @@FETCH_STATUS = 0 BEGIN
			BEGIN TRY
				...
				INSERT INTO bo3 (bo3stamp,codpais,descpais,ousrinis, ousrdata, ousrhora, usrinis, usrdata, usrhora, documentnumberori, motanul, taxpointdt) VALUES(@bostamp, @CODPAIS, @DESCRPAIS, @ousrinis, @ousrdata, @ousrhora, @usrinis, @usrdata, @usrhora, @InvoiceNO, @motanul, @usrdata)
				...
				BEGIN
					...
					EXECUTE SPMSS_DocDossInternLin @DCCEXR, @DCCTPD, @DCCSER, @obrano, @EstabSeparator, @no, @estab, @bostamp, @dataobra, @dataobra, @local, @morada, @codpost, @nome, @DocDesc, @ArmOrigem, @ArmDestino, @ENTIDADE, @DocAnul, @Imp1, @Imp2, @Imp3
