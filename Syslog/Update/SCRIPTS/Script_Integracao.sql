			...
			SELECT 
					...
					WHILE @@FETCH_STATUS = 0 BEGIN
						...
						BEGIN						
							...
							UPDATE u_Kapps_DossierLin SET Integrada = 'S', Status = 'F', DataIntegracao = @DateStr, HoraIntegracao = SUBSTRING(@TimeStr,1,6), StampDocGer = RIGHT(@NEWnmdos + ' ' + CAST(@NEWobrano AS VARCHAR),50), KeyDocGerado=@NewBoStamp WHERE StampLin = @StampLin
