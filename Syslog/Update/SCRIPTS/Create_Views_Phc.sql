...
CASE WHEN trfa = 1 THEN bdempresas WHEN (bdempresas = 'CL') THEN 'CL' WHEN (bdempresas = 'FL') THEN 'FL'  ELSE 'I' END  as Entity
,1 as 'ValidaStock'
,0 as 'StockBreak'
,'' as DefaultEntity
from ts (NOLOCK)
...
select distinct SerialNumber, Article
from (
Select ans.SERIE as SerialNumber, ans.Ref as Article
